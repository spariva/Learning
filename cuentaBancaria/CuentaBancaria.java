<<<<<<< Updated upstream:cuentaBancaria/CuentaBancaria.java
...
//
    ...
    public void checkStatusAccount() {
        System.out.println("Titular: " + titular + "con número de cuenta: " + numeroCuenta + 
        " y un saldo de: " + saldo + moneda);
    }
    public boolean retirarDinero(double dineroRetirado) {
        if(dineroRetirado > saldo){
            return false;
...
- hacerTransferencia(???)
- Otros métodos que se puedan necesitar
>>>>>>> Stashed changes:CuentaBancaria.java
 */