...
CREATE TABLE LINEA_PEDIDO(
    ...
    CONSTRAINT FK_LIN_PED FOREIGN KEY (NUM_PEDIDO) REFERENCES PEDIDO(NUMERO) ON DELETE CASCADE,
    CONSTRAINT FK_LIN_PROD FOREIGN KEY (COD_PRODUCTO) REFERENCES PRODUCTOS(CODIGO) ON DELETE CASCADE,
    CONSTRAINT PK_LINEA_PED PRIMARY KEY (NUM_LINEA, NUM_PEDIDO, COD_PRODUCTO)
);
